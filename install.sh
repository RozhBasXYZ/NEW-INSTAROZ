...
pkg install git nano openssl binutils build-essential python3.10 -y
...
cd NEW-INSTAROZ && python3.10 -m pip install --upgrade pip && python3.10 -m pip install wheel && python3.10 -m pip install -r requirements.txt
